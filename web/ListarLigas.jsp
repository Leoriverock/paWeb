...
<div id="main">
    ...
    <%
             ...
             try{
                    ResultSet tabla =  mbd.getStatement().executeQuery("select * from competiciones where tipo='liga'");
                    while (tabla.next()) {
             ...
             <table class="table table-bordered">
                    <tr>
                        ...
                        <%
                            ...
                            {
                               out.println("<tr>");
                               out.println("<td><a href=EquiposLiga.jsp?id_c="+ListaCompeticiones.get(i).getId()+">"+ListaCompeticiones.get(i).getNombre()+"</a></td>");
                               out.println("</tr>");
                            }
                        %>
                </table>
