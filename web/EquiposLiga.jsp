...
<div id="main">
    ...
    <%
             ...
             try{
                    ResultSet tabla = mbd.getStatement().executeQuery("select * from equipos e, liga_equipo l where l.id_liga="+id_c+" and e.id_equipos=l.id_equipo");
                    while (tabla.next()) {
                       Equipos e = new Equipos();
                       e.setId(tabla.getObject("e.id_equipos").toString());
                       e.setNombre(tabla.getObject("e.nombre").toString());
                       ListaEquipos.add(e);
                   }
             ...
             <table class="table table-bordered">
                    <tr>
                        ...
                        <%
                            ...
                            {
                               out.println("<tr>");
                               out.println("<td><a href=VerDetalleEquipo.jsp?id_e="+ListaEquipos.get(i).getID()+"&idc="+id_c+">"+ListaEquipos.get(i).getNombre()+"</a></td>");
                               out.println("</tr>");
